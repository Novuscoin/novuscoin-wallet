...
import de.schildbach.wallet.Novuscoin.integration.android.NovuscoinIntegration;
...
public class SampleActivity extends Activity
{
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		donateButton.setOnClickListener(new OnClickListener()
		{
			...
			{
				NovuscoinIntegration.requestForResult(SampleActivity.this, REQUEST_CODE, DONATION_ADDRESS);
			}
		});
	...
	protected void onActivityResult(final int requestCode, final int resultCode, final Intent data)
	{
		if (requestCode == REQUEST_CODE)
		{
			...
			{
				final String txHash = NovuscoinIntegration.transactionHashFromResult(data);
				if (txHash != null)
				{
